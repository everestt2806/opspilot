...
const line = (seq: number, version = '1.0.0'): string => JSON.stringify({
  seq, ts: '2026-08-30T00:00:00Z', cpu_pct: 1, mem_mb: 2, mem_pct: 3, mem_limit_mb: 4,
  latency_ms: null, http_error_rate: 0, db_response_ms: null, container_up: 1,
  host_cpu_pct: null, host_mem_pct: null, collector_version: version
})
