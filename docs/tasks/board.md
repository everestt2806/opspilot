...
| ------ | -------------------------------------------------------------------- | --------------------- | --------- | ---------- | --------------------------- | --------------------------- | ----------------------------------------------------------------- |
| TK-A18 | UI Windows 11 Fluent, Mica/native titlebar, dark mặc định            | A/Worker              | 14/09     | CHỜ REVIEW | `feat/a18-native-dark-ui`   | READY_FOR_LOCAL_REVIEW      | R2-01…07 fixed locally; checkpoints `a233a2e`, `e9cb70c`, `197c703`, `9eff0cc`; Snap manual-only |
