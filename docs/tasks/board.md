...
|---|---|---|---|---|---|---|---|
| TK-A16 | M6: poll JSONL → metric/5 score/alert → monitor IPC | A | 04/09 | ĐANG LÀM | `feat/m06-monitor-poller-rule` | — | review 03 code `6f1da37`: reviewer Node 22 192/192 PASS; còn R3-01/R3-02 BLOCKING, R3-03…R3-05 MAJOR · chưa push |
