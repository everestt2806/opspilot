...
|---|---|---|---|---|---|---|---|
| TK-A16 | M6: poll JSONL → metric/5 score/alert → monitor IPC | A | 04/09 | CHỜ REVIEW | `feat/m06-monitor-poller-rule` | — | local HEAD · chưa push; review-06 R6-01…R6-04 đã sửa, focused 25/25, CLI 150/750/0, lint/typecheck/scoped Prettier/build PASS; full renderer-only 11 failures, isolated 3/3 |
