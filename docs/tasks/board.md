...
| ------ | -------------------------------------------------------------------- | --------------------- | --------- | ---------- | --------------------------- | --------------------------- | ----------------------------------------------------------------- |
| TK-A18 | UI desktop native, dark mặc định, giảm web/AI slop                   | A/Worker              | 14/09     | ĐANG LÀM   | `feat/a18-native-dark-ui`   | CHANGES_REQUESTED R1        | A18-R1-01…07; rollback demo `936e643`; chưa push/PR/merge         |
