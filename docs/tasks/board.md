...
|---|---|---|---|---|---|---|---|
| TK-A16 | M6: poll JSONL → metric/5 score/alert → monitor IPC | A | 04/09 | BLOCKED | `feat/m06-monitor-poller-rule` | — | vòng sửa local `4b762dc` · test toàn repo đỏ 2 renderer timeout · chưa push |
