...
| TK-B6  | M5: chạy collector Docker trên VM01                                  | B    | 03/09 | CHỜ REVIEW | `feat/m05-collector-docker` | Sau TK-B5                | VM02 (VM01 còn chặn TCP/22) · smoke 10,5' 63 dòng PASS · chưa push |
