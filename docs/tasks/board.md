...
| TK-A14 | Dashboard v1: tổng quan VPS + lịch sử + log deploy live | A | 23/08 | ĐANG LÀM | feat/ui-dashboard-v1 | — | Ops dashboard cho demo (không chart metric — collector lùi W2). Chunk 1 xong: `history:list` IPC + DashboardPage + nút "Xem dashboard". |
