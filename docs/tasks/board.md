...
| ------ | -------------------------------------------------------------------- | --------------------- | --------- | ---------- | --------------------------- | --------------------------- | ----------------------------------------------------------------- |
| TK-A18 | UI Windows 11 Fluent, Mica/native titlebar, dark mặc định            | A/Worker              | 14/09     | CHỜ REVIEW | `feat/a18-native-dark-ui`   | local Review-Fix 02; chưa push/PR/merge | F0–F3; MICA_FALLBACK; rollback `936e643` |
