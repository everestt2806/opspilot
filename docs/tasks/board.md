...
|---|---|---|---|---|---|---|---|
| TK-A16 | M6: poll JSONL → metric/5 score/alert → monitor IPC | A | 04/09 | ĐANG LÀM | `feat/m06-monitor-poller-rule` | — | review 04 code `4ed705f`: R4 fixes có regression; monitor 17/17 + CLI PASS, lint/typecheck/scoped Prettier PASS; full test/build chưa kết thúc · local handoff sau HEAD · chưa push |
