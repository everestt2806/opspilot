...
| TK-A13 | M4 lát cắt demo: deploy Express thật lên VM01 (PRECHECK→RECORD) | A | 23/08 | CHỜ REVIEW | feat/m04-deploy-express | — | Pipeline + try-deploy + UI DeployPage (wizard + log live + nút Cài Docker) xong: 108 test/lint/typecheck xanh. Còn 2 DoD chờ **mở port 30000–30999 phía user** (firewall WiService): curl từ ngoài + click-through UI thật trên VM01. Hồ sơ: `tk-a13-m4-deploy-slice.md` |
