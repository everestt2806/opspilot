...
|---|---|---|---|---|---|---|---|
| TK-A16 | M6: poll JSONL → metric/5 score/alert → monitor IPC | A | 04/09 | ĐANG LÀM | `feat/m06-monitor-poller-rule` | — | review 06 tại `b35c821`: R6-01 BLOCKING, R6-02…R6-04 MAJOR; focused 18/18, CLI/lint/typecheck/Prettier/build PASS; full 180/195 renderer baseline · chưa push |
