...
| ------ | -------------------------------------------------------------------- | --------------------- | --------- | ---------- | --------------------------- | --------------------------- | ----------------------------------------------------------------- |
| TK-A18 | UI desktop native, dark mặc định, giảm web/AI slop                   | A/Worker              | 14/09     | ĐANG LÀM   | `feat/a18-native-dark-ui`   | Task packet trên `66ab90b`  | Renderer-only; rollback demo `936e643`; local worker started 13/09 |
