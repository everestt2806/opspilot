...
|---|---|---|---|---|---|---|---|
| TK-A16 | M6: poll JSONL → metric/5 score/alert → monitor IPC | A | 04/09 | BLOCKED | `feat/m06-monitor-poller-rule` | — | vòng sửa 2 local `d4f9d45` + docs handoff · Node22 monitor/CLI PASS, full test 190/192 · chưa push |
