...
| ------ | -------------------------------------------------------------------- | --------------------- | --------- | ---------- | --------------------------- | --------------------------- | ----------------------------------------------------------------- |
| TK-A18 | UI Windows 11 Fluent, Mica/native titlebar, dark mặc định            | A/Worker              | 14/09     | ĐANG LÀM   | `feat/a18-native-dark-ui`   | CHANGES_REQUESTED R2        | A18-R2-01…07; titlebar/evidence/gate chưa đạt; rollback `936e643` |
