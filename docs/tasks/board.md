...
|---|---|---|---|---|---|---|---|
| TK-A16 | M6: poll JSONL → metric/5 score/alert → monitor IPC | A | 04/09 | ĐANG LÀM | `feat/m06-monitor-poller-rule` | — | review 04 code `f268277`: R4-01 BLOCKING, R4-02…R4-06 MAJOR; monitor 16/16 + CLI PASS, scoped Prettier FAIL, full runner chưa kết thúc · chưa push |
