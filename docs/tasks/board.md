...
| ------ | -------------------------------------------------------------------- | --------------------- | --------- | ---------- | --------------------------- | --------------------------- | ----------------------------------------------------------------- |
| TK-A18 | UI desktop native, dark mặc định, giảm web/AI slop                   | A/Worker              | 14/09     | CHỜ REVIEW | `feat/a18-native-dark-ui`   | local handoff; chưa push/PR/merge | Renderer-only; rollback demo `936e643`; READY_FOR_LOCAL_REVIEW |
